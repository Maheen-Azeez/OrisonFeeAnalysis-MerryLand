...
{
    public interface IMerryLandStudentMaster
    {
        public Task<IEnumerable<dtStudentRegister>> GetStudentList(string AcademicYear, int BranchID);
        public Task<IEnumerable<dtStudentRegister>> GetStudentListTeacher(string AcademicYear, int BranchID, int UserID);
        ...
        public Task<IEnumerable<SchoolClass>> GetActivity(string AcademicYear, int BranchID);
        ...
        public Task<IEnumerable<dtStudentRegister>> GetSiblingRegister(int ParentID, int BranchID, int AccountID,string academicYear);

        public Task<string> GetStaffID(int BranchID, String Code);
        public Task<IEnumerable<dtFeeStatus>> GetFeeStatus(int AccountID, string AcademicYear, int BranchID);
